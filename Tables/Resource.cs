namespace AnyDexDB.Tables {
	public partial class Resource {
		public Resource() {
			...
			ResourcerelationRelatedResources = new HashSet<ResourceRelation>();
			ResourcerelationResources = new HashSet<ResourceRelation>();
		}
		...
		public virtual ICollection<ResourceRelation> ResourcerelationRelatedResources { get; set; }
		public virtual ICollection<ResourceRelation> ResourcerelationResources { get; set; }
	}
}
